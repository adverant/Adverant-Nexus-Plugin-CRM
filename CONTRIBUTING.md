...
1. Check the [existing issues](https://github.com/adverant/Adverant-Nexus-Plugin-CRM/issues) to avoid duplicates
...
```bash
git clone https://github.com/YOUR_USERNAME/Adverant-Nexus-Plugin-CRM.git
cd Adverant-Nexus-Plugin-CRM
npm install
npm run dev
```
